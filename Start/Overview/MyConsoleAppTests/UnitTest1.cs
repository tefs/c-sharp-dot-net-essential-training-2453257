...
MyConsoleAppTests
{
    ...
    public class AreYouPlayingBanjo
    {
        ...
        public static void TechnicalExam_TestDome_Sum_Test()
        {
            ...
            int result = Adder.Sum(new Func<int>[] { expensiveFunction, cheapFunction }, onSumChanged);
    ...
    public class KataTests
    {
        ...
        {
            Assert.AreEqual("Computer", UniqueProduct.FirstUniqueProduct(new string[] { "Apple", "Computer", "Apple", "Bag" }));
        }
        [Test]
